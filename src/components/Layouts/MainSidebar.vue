        ...
        <li v-for="(tab, tabIndex) in tabData" :key="tabIndex" class="nav-item">    
          ...
          <template v-if="tab.name !== 'Expenses'">
             <router-link v-if="!tab.subMenu" :to="tab.link" class="nav-link">
              ...
              <img :src="require(`../../assets/img/icons/${tab.icon}`)" alt="Image" onerror="this.onerror=null; this.src='../../assets/img/icons/dashboard.svg';" />
          ...
          <template v-if="tab.name === 'Expenses' && showExpensesTab">
             <router-link v-if="!tab.subMenu" :to="tab.link" class="nav-link">
              <img :src="require(`../../assets/img/icons/${tab.icon}`)" alt="Image" onerror="this.onerror=null; this.src='../../assets/img/icons/dashboard.svg';" /> <!-- <img :src="tab.icon" alt="Image" /> -->
              <span class="nav-text d-block fs-14 fw-light">{{ tab.name }}</span>
            </router-link>
            <a v-else href="javascript:void(0)" class="nav-link">
             
              <img :src="require(`../../assets/img/icons/${tab.icon}`)" alt="Image" onerror="this.onerror=null; this.src='../../assets/img/icons/dashboard.svg';" /> <span class="nav-text d-block fs-14">{{ tab.name }}</span>
            </a>
          </template>
          ...
          <ul v-if="tab.subMenu" class="sidebar-secondary-menu list-style bg-white">
            <li v-for="(subItem, subIndex) in tab.subMenu" :key="subIndex" class="nav-item">
              <router-link :to="subItem.link">
                ...
                <img :src="require(`../../assets/img/icons/${subItem.icon}`)" alt="Image" onerror="this.onerror=null; this.src='../../assets/img/icons/dashboard.svg';" />
...
export default {
  ...
  data() {
  return {
    showExpensesTab: false, // Set this to false to hide the Expenses tab
    tabData: [
      {
        name: "Dashboard",
        icon: "dashboard.svg",
